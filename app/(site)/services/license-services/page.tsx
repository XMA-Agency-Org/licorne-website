import HeroImage from "@/public/images/heroes/license-services.jpg";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "License Services Dubai | Licorne Corporate Services",
    description:
      "Renewal, modification, cancellation and freezing of UAE trade licenses, handled end to end.",
    type: "website",
  },
};

export default function LicenseServicesPage() {
