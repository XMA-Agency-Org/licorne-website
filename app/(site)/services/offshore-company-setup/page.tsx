import HeroImage from "@/public/images/heroes/free-zone-company-setup.jpg";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Offshore Company Setup UAE | Licorne Corporate Services",
    description:
      "Asset holding and international structuring through a UAE offshore company, set up in days.",
    type: "website",
  },
};

export default function OffshoreCompanySetupPage() {
